...
public class BiomeGenerationNoiseCondition {
    ...
    private final int modRarityOffset;
    ...
    public BiomeGenerationNoiseCondition(boolean disabledCompletely, int distanceFromSpawn, int modRarityOffset, float[] continentalness, float[] erosion, float[] humidity, float[] temperature, float[] weirdness, float[] depth) {
        ...
        this.depth = depth;
        this.modRarityOffset = modRarityOffset;
    }
    ...
    public boolean test(EventReplaceBiome event) {
        ...
        if (!ModBiomeRarity.testBiomeRarity(event.getWorldSeed(), modRarityOffset, event.getX(), event.getZ())) {
            return false;
        }
    ...
    public static final class Builder {
        ...
        public Builder modRarityOffset(int rarityOffset) {
