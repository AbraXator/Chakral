...
public class ModBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider p_256380_) {
        ...
        List<RegistryObject<Block>> axe = List.of(ModBlocks.WILTED_LOG, ModBlocks.WILTED_PLANKS, ModBlocks.SHARD_REFINER, ModBlocks.WILTED_SLAB, ModBlocks.WILTED_STAIRS, ModBlocks.WILTED_DOOR, ModBlocks.WILTED_TRAPDOOR, ModBlocks.WILTED_BUTTON, ModBlocks.WILTED_PRESSURE_PLATE, ModBlocks.WILTED_WOOD, ModBlocks.STRIPPED_WILTED_WOOD, ModBlocks.STRIPPED_WILTED_LOG);
