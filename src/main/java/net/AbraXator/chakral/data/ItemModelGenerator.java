...
public class ItemModelGenerator extends ItemModelProvider {
    ...
    private ItemModelBuilder goldenNecklace(){
        return withExistingParent(ModItems.GOLDEN_NECKLACE.getId().getPath(), new ResourceLocation("item/generated"))
                ...
                .model(new ModelFile.ExistingModelFile(new ResourceLocation(Chakral.MOD_ID, "item/necklace/golden_necklace_crown"), existingModelFile))
                .predicate(new ResourceLocation("heart"), 1.0F)
                .model(new ModelFile.ExistingModelFile(new ResourceLocation(Chakral.MOD_ID, "item/necklace/golden_necklace_heart"), existingModelFile))
                .predicate(new ResourceLocation("root"), 1.0F)
                .model(new ModelFile.ExistingModelFile(new ResourceLocation(Chakral.MOD_ID, "item/necklace/golden_necklace_root"), existingModelFile))
                .predicate(new ResourceLocation("sacral"), 1.0F)
                .model(new ModelFile.ExistingModelFile(new ResourceLocation(Chakral.MOD_ID, "item/necklace/golden_necklace_sacral"), existingModelFile))
                .predicate(new ResourceLocation("solar"), 1.0F)
                .model(new ModelFile.ExistingModelFile(new ResourceLocation(Chakral.MOD_ID, "item/necklace/golden_necklace_solar"), existingModelFile))
                .predicate(new ResourceLocation("third_eye"), 1.0F)
                .model(new ModelFile.ExistingModelFile(new ResourceLocation(Chakral.MOD_ID, "item/necklace/golden_necklace_third_eye"), existingModelFile))
                .predicate(new ResourceLocation("throat"), 1.0F)
                .model(new ModelFile.ExistingModelFile(new ResourceLocation(Chakral.MOD_ID, "item/necklace/golden_necklace_throat"), existingModelFile))
                .end();
    }
