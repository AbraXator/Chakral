...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> BIG_BLACK_BUD                 = registerBlock("black_big_bud", () -> new Crystal(BlockBehaviour.Properties.of(Material.AMETHYST, MaterialColor.COLOR_BLACK).strength(9f).requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> SMALL_BLACK_BUD               = registerBlock("black_small_bud", () -> new Crystal(BlockBehaviour.Properties.of(Material.AMETHYST, MaterialColor.COLOR_BLACK).strength(9f).requiresCorrectToolForDrops()));
