...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> BIG_BLACK_BUD                 = registerBlock("big_black_bud", () -> new Crystal(BlockBehaviour.Properties.of(Material.AMETHYST, MaterialColor.COLOR_BLACK).strength(9f).requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> SMALL_BLACK_BUD               = registerBlock("small_black_bud", () -> new Crystal(BlockBehaviour.Properties.of(Material.AMETHYST, MaterialColor.COLOR_BLACK).strength(9f).requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> BUDDING_BLACK_MINERAL         = registerBlock("budding_black_mineral", () -> new ModBuddingBlock(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.COLOR_BLACK).randomTicks().strength(9f).requiresCorrectToolForDrops(), List.of(ModBlocks.BLACK_CRYSTAL.get(), ModBlocks.BLACK_CRYSTAL.get(), ModBlocks.BLACK_CRYSTAL.get())));
    //---------------------GLOWSTONE-------------------
    ...
    public static final RegistryObject<Block> BIG_TRUE_WHITE_BUD            = registerBlock("big_true_white_bud", () -> new Crystal(BlockBehaviour.Properties.of(Material.AMETHYST, MaterialColor.SNOW).strength(9f).requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> SMALL_TRUE_WHITE_BUD          = registerBlock("small_true_white_bud", () -> new Crystal(BlockBehaviour.Properties.of(Material.AMETHYST, MaterialColor.SNOW).strength(9f).requiresCorrectToolForDrops()));
    //--------------------PURPLE---------------------
    ...
    public static final RegistryObject<Block> BIG_BLUE_BUD                  = registerBlock("big_blue_bud", () -> new Crystal(BlockBehaviour.Properties.of(Material.AMETHYST).strength(9f).lightLevel(value -> 4).requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> SMALL_BLUE_BUD                = registerBlock("small_blue_bud", () -> new Crystal(BlockBehaviour.Properties.of(Material.AMETHYST).strength(9f).lightLevel(value -> 4).requiresCorrectToolForDrops()));
    ...
    public static final RegistryObject<Block> BIG_LIGHT_BLUE_BUD            = registerBlock("big_light_blue_bud", () -> new Crystal(BlockBehaviour.Properties.of(Material.STONE).strength(9f).lightLevel(value -> 4).requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> SMALL_LIGHT_BLUE_BUD          = registerBlock("small_light_blue_bud", () -> new Crystal(BlockBehaviour.Properties.of(Material.STONE).strength(9f).lightLevel(value -> 4).requiresCorrectToolForDrops()));
    //--------------------GREEN---------------------
    ...
    public static final RegistryObject<Block> BIG_GREEN_BUD                 = registerBlock("big_green_bud", () -> new Crystal(BlockBehaviour.Properties.of(Material.AMETHYST).strength(9f).lightLevel(value -> 4).requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> SMALL_GREEN_BUD               = registerBlock("small_green_bud", () -> new Crystal(BlockBehaviour.Properties.of(Material.AMETHYST).strength(9f).lightLevel(value -> 4).requiresCorrectToolForDrops()));
    ...
    public static final RegistryObject<Block> BIG_YELLOW_BUD                = registerBlock("big_yellow_bud", () -> new Crystal(BlockBehaviour.Properties.of(Material.AMETHYST).lightLevel(value -> 4).strength(9f).requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> SMALL_YELLOW_BUD              = registerBlock("small_yellow_bud", () -> new Crystal(BlockBehaviour.Properties.of(Material.AMETHYST).lightLevel(value -> 4).strength(9f).requiresCorrectToolForDrops()));
    //--------------------ORANGE---------------------
    ...
    public static final RegistryObject<Block> BIG_ORANGE_BUD                = registerBlock("big_orange_bud", () -> new Crystal(BlockBehaviour.Properties.of(Material.AMETHYST).lightLevel(value -> 4).strength(9f).requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> SMALL_ORANGE_BUD              = registerBlock("small_orange_bud", () -> new Crystal(BlockBehaviour.Properties.of(Material.AMETHYST).lightLevel(value -> 4).strength(9f).requiresCorrectToolForDrops()));
    //--------------------RED------------------------
    ...
    public static final RegistryObject<Block> BIG_RED_BUD                   = registerBlock("big_red_bud", () -> new Crystal(BlockBehaviour.Properties.of(Material.AMETHYST).lightLevel(value -> 4).strength(9f).requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> SMALL_RED_BUD                 = registerBlock("small_red_bud", () -> new Crystal(BlockBehaviour.Properties.of(Material.AMETHYST).lightLevel(value -> 4).strength(9f).requiresCorrectToolForDrops()));
