...
public class Chakras {
    ...
    //THIRD EYE
    public static final RegistryObject<Chakra> HAG_STONE_CHAKRA =          ChakraRegistries.CHAKRA.register("hag_stone_chakra", () -> new HagStone(UUID.randomUUID())); //TOOL RANGE
    public static final RegistryObject<Chakra> DUMORTIERITE_CHAKRA =       ChakraRegistries.CHAKRA.register("dumortierite_chakra", Dumortierite::new);                  //UKÁŽE ORE PO FALL DAMAGE
    //THROAT
    ...
    //HEART
    public static final RegistryObject<Chakra> AMAZONITE_CHAKRA =          ChakraRegistries.CHAKRA.register("amazonite_chakra", AmazoniteChakra::new);                  //BONUS HP
    ...
    //SOLAR
    public static final RegistryObject<Chakra> HELIOLITE_CHAKRA =          ChakraRegistries.CHAKRA.register("heliolite_chakra", HelioliteChakra::new);                  //3x3 SEEDS
