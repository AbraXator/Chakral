...
public class ModEntities {
    ...
    public static final RegistryObject<EntityType<ChakralBoat>> BOAT = buildNoEgg(new ChakralLocation("boat"), makeCastedBuilder(ChakralBoat.class, ChakralBoat::new, 1.375F, 0.562F, 10, 3), false);
    public static final RegistryObject<EntityType<ChakralChestBoat>> CHEST_BOAT = buildNoEgg(new ChakralLocation("chest_boat"), makeCastedBuilder(ChakralChestBoat.class, ChakralChestBoat::new, 1.375F, 0.562F, 10, 3), false);
